...
y_stretch = pyrb.time_stretch(y, sr, 2)
# Play back extra low tones
y_shift = pyrb.pitch_shift(y, sr, 2)
sf.write("analyzed_filepathX2.wav", y_stretch, sr, format='wav')

sound = AudioSegment.from_wav("analyzed_filepathX2.wav")
sound.export("analyzed_filepathX5.m23", format="mp3")
